...
export default function Login() {
  const {error, handleLogChange, handleLogSubmit, handleContent } = useContext(appContext);
  return (
    <div className="bg-[#161520] p-[2rem]">
      <h1 className="mb-[1.5rem] text-white text-center font-extrabold text-4xl p-[0.5rem]">
        Iniciar Sesion
      </h1>
      <form onSubmit={handleLogSubmit} className="flex flex-col w-[30rem] gap-[1rem] text-white">
