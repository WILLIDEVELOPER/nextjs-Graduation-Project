...
export default function Content() {
  ...
  if (contentId == "HomeAdmin") {
    return (
      ...
      >
        <div class="w-full h-full relative overflow-x-auto shadow-md sm:rounded-lg">
          ...
          <div class="flex items-center justify-between py-4 bg-transparent">
            <div>
              <button
                id="dropdownActionButton"
                data-dropdown-toggle="dropdownAction"
                class="inline-flex items-center font-bold  border border-gray-300 focus:outline-none hover:bg-[#7c20ec] focus:ring-4 focus:ring-gray-200 rounded-lg text-sm px-3 py-1.5 bg-[#8F43EE]    "
                type="button"
              >
                <span class="sr-only">Action button</span>
                Actions
